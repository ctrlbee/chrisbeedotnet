...
var ReactEmptyComponentRegistry = __webpack_require__(78);
...
var _connect = __webpack_require__(132);
...
exports.actionGetNewsSources = actionGetNewsSources;
...
var _containerNewsSources = __webpack_require__(239);

var _containerNewsSources2 = _interopRequireDefault(_containerNewsSources);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_containerNewsSources2.default, null)
      );
    }
  }]);
...
var _reducerGeneric = __webpack_require__(128);

var _reducerGetNewsSources = __webpack_require__(129);

var rootReducer = (0, _redux.combineReducers)({
  generic: _reducerGeneric.reducerGeneric,
  newsSources: _reducerGetNewsSources.reducerGetNewsSources
...
exports.actionGeneric = actionGeneric;
...
exports.reducerGetNewsSources = reducerGetNewsSources;
function reducerGetNewsSources() {
...
var _wrapActionCreators = __webpack_require__(134);
...
var _fluxStandardAction = __webpack_require__(218);
...
var _lodashIsplainobject = __webpack_require__(219);
...
var ContainerNewsSources = function (_Component) {
  _inherits(ContainerNewsSources, _Component);

  function ContainerNewsSources(props) {
    _classCallCheck(this, ContainerNewsSources);

    return _possibleConstructorReturn(this, (ContainerNewsSources.__proto__ || Object.getPrototypeOf(ContainerNewsSources)).call(this, props));
  }

  _createClass(ContainerNewsSources, [{
    ...
    value: function renderSources() {
      return this.props.newsSources.map(function (source) {
        return _react2.default.createElement(
          'ul',
          null,
  ...
  return ContainerNewsSources;
}(_react.Component);

function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({ getNewsSources: _index.actionGetNewsSources }, dispatch);
}
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ContainerNewsSources);
